...
namespace webVS2019.Migrations
{
    ...
    [Migration("20200522222304_AddIsDeleted")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webVS2019.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("webVS2019.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("webVS2019.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("webVS2019.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("webVS2019.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("webVS2019.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("webVS2019.Models.Course", b =>
                {
                    b.HasOne("webVS2019.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("webVS2019.Models.CourseInstructor", b =>
                {
                    b.HasOne("webVS2019.Models.Course", "Course")
                    ...
                    b.HasOne("webVS2019.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("webVS2019.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("webVS2019.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("webVS2019.Models.OfficeAssignment", b =>
                {
                    b.HasOne("webVS2019.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("webVS2019.Models.OfficeAssignment", "InstructorId")
